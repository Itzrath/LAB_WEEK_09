        ...
        item {
            Column(
                modifier = Modifier
                    .padding(16.dp)
                    .fillMaxSize(),
                // Aligns the Column vertically (Note: the original comment likely meant horizontally)
                horizontalAlignment = Alignment.CenterHorizontally
            ) {
                // IMPORTANT: You need to ensure you have a string resource defined
                // in your res/values/strings.xml for R.string.enter_item
                ...
                Button(onClick = { }) {
                    ...
                    // IMPORTANT: You need to ensure you have a string resource defined
                    // in your res/values/strings.xml for R.string.button_click
                    Text(text = stringResource(
